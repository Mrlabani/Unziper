...
Report this at @x_04i if you think this is a mistake, I may unban you
    """
...
**Powered by @LAbani_Botz**
    ...
    BOT_RUNNING = "Bot is running now ! Join @LAbani_Botz"
...
Successfully extracted by @x_04i 🥰
    """
...
Please report this at @x_04i if you think this is a serious error
    """
...
**• I wanna have help 🥺**
    ...
    PM me at **@x_04i** or join the chat **@x_04i**
    """

    ABOUT_TXT = """
**About Unarchiver bot [v6.3.3]**

• **[Paypal](https://www.paypal.me/Labaniking)**
• **[GitHub Sponsors](https://github.com/Mrlabani)**
• **[Directly in Telegram](https://t.me/x_04i)**
• **[BuyMeACoffee](mrlabani.vercel.app)**
• **[Send cryptos (not recommended)](https://noobscript.fun)**

**[Rate me ⭐](https://t.me/x_04i)**
Made with ❤️ by **@LAbani_Botz**
    """
...
3) Send a screenshot of your payment to **@x_04i**
...
If you believe it's an error, send the file to **@x_04i**
    """
...
Please contact @x_04i with details and screenshots
    """
...
If it fails again, it means that {} haven't started the bot yet (or deleted the chat), or he's private/banned/whatever
    ...
    REPORT_REPLY = "Reply to a message to report it to @x_04i"

    REPORT_DONE = """
Report sucessfully sent ! An answer will arrive soon

Note : if you need to reply to replies, always use that /report command (or join **@x_04i**)
    """
...
**/logs** : Send you the logs (all of them). Useful for bug tracking. Send them to **@x_04i** if you don't understand them/need help
